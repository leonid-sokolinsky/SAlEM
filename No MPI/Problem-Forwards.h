...
//====================== Private Functions =====================================
namespace PF {
	void	Bss_AddToBasis_i(int i, int* basis, int* m_basis, double eps_zero);
	void	Bss_EdgeBasis_v(int* neHyperplanes_v, int mne_v, int meq, int* edgeBasis_v, double eps_zero);
	void	Bss_MakeEquationsBasis(int* basis, int* meq_basis, double eps_zero);
	void	CalculateNumberOfCombinations(int neq, int mne_u, int subspaceDim, int* TWIDDLE_p, int* mco_u);
